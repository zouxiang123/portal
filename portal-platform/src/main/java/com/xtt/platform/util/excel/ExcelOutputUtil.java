...
public class ExcelOutputUtil {
	 ...
	 * @param srcFile		excel模板文件
	 * @param excelData		导出excel数据
	 * @param discFile		生成的目录位置
	 ...
	 * @param exportFileName 	下载文件名称
	 * @param response			请求response对象
	 * @param request			请求request对象
	 * @return
	 *
	 */
	public static boolean outputDownload(String srcFile,Map<String,Object> excelData,String exportFileName,HttpServletRequest request,HttpServletResponse response){
		try {
	 ...
	 * @param excelData		生成文件位置
	 * @throws IOException 
	 * @throws InvalidFormatException 
	 * @throws ParsePropertyException 
	 *
	 */
	private static void output(String srcFile,Map<String,Object> excelData,String discFile) throws ParsePropertyException, InvalidFormatException, IOException{
	 ...
	 *
	 */
	private static Workbook outputWorkBook(String srcFile,Map<String,Object> excelData) throws ParsePropertyException, InvalidFormatException, IOException{
		XLSTransformer transformer = new XLSTransformer();
