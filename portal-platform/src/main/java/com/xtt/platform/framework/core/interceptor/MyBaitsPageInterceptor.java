...
public class MyBaitsPageInterceptor implements Interceptor {
	...
	/**
	 * 根据PageModel对象获取对应的分页查询Sql语句，这里只做了两种数据库类型，Mysql和Oracle 其它的数据库都 没有进行分页
	 * 
	 * @param PageModel
	 *            分页对象
	 * @param sql
	 ...
	 *            当前的数据库连接
	 */
	private void setTotalRecord(MyBatisSuperModel PageModel, MappedStatement mappedStatement, Connection connection) {
